...
namespace MG_Server
{
    ...
    {
        public const string RetrainFilePath =  @"TrainData\TikTakToe\data.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=89,NumberOfLeaves=7,FeatureFraction=1F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}));
